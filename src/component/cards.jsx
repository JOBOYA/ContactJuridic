...
const Modal = ({ closeModal, children }) => (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-8">
            <button className="float-right text-gray-600" onClick={closeModal}>
                &times;
            </button>
            {children}
        </div>
        ...
        <div className="cards" >
            {showModal && (
                <Modal closeModal={closeModal}>
                    <h2 className="text-xl font-bold mb-4">Qu'est-ce qu'un micro-entrepreneur ?</h2>
                    <p>Les micro-entrepreneurs sont généralement des travailleurs indépendants, <br />
                        des professions libérales ou des artisans qui souhaitent démarrer ou exercer <br />
                        une activité à petite échelle. Ce régime convient aux entrepreneurs dont le chiffre<br />
                        d'affaires annuel ne dépasse pas certains seuils, qui sont régulièrement révisés.</p>
                </Modal>
            )}
            <div className="p-10 card__grid place-items-center  place-content-center min-h-screen">
                ...
                <div className="card--1 bg-white shadow-xl rounded-3xl max-w-xs pt-4 pb-8 px-4" ref={cardRef1} style={cardStyle}>
                    ...
                    <div>
                        {/* Ajoutez un événement onClick au bouton de la carte pour afficher la modale */}
                        <button
